...
- do start by reading `package.json`, `tsconfig.json`, `src/generate-theme.ts`, and the generated theme JSON files in `themes/` to understand how the extension is generated and contributed.
