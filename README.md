...
A quiet theme collection for Visual Studio Code with consistent editor surfaces, warm blackboard-inspired highlighting, medium-grey dark and light-mode variants, an optional subtle bordered variant, and a light mockup-inspired option.
