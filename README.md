...
[![Version](https://img.shields.io/badge/version-0.5.16-d8b84d?style=flat-square)](https://marketplace.visualstudio.com/items?itemName=jackrobertscott.jacks-theme)
...
- Jack's Theme Mockup uses warm paper surfaces, graphite text, blueprint selections, sticky-note highlights, redline diagnostics, and pencil-like guide colors to feel intentionally early-stage without harsh white glare.
