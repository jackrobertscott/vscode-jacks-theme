...
const palette = {
  ink0: oklch(0.132, 0.021, 228),
  ink1: oklch(0.165, 0.023, 226),
  ink2: oklch(0.205, 0.027, 226),
  ink3: oklch(0.255, 0.031, 226),
  ink4: oklch(0.315, 0.035, 226),
  ink5: oklch(0.392, 0.037, 226),
  ink6: oklch(0.505, 0.035, 226),
  text: oklch(0.895, 0.025, 225),
  textSoft: oklch(0.79, 0.032, 224),
  textMuted: oklch(0.63, 0.036, 224),
  textFaint: oklch(0.49, 0.033, 224),
  comment: oklch(0.59, 0.052, 176),
  cyan: oklch(0.795, 0.124, 211),
  teal: oklch(0.76, 0.13, 184),
  mint: oklch(0.785, 0.138, 158),
  green: oklch(0.755, 0.128, 143),
  blue: oklch(0.755, 0.118, 244),
  violet: oklch(0.765, 0.13, 292),
  purple: oklch(0.71, 0.139, 310),
  rose: oklch(0.735, 0.135, 348),
  coral: oklch(0.755, 0.142, 25),
  amber: oklch(0.82, 0.135, 82),
  gold: oklch(0.785, 0.12, 96),
  red: oklch(0.69, 0.168, 21),
  orange: oklch(0.765, 0.142, 54),
  shadow: oklch(0.04, 0.014, 228),
  white: oklch(0.985, 0.005, 225)
} as const;
