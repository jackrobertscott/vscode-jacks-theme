...
const createWorkbenchColors = (C: Palette): Theme["colors"] => {
  ...
  return {
    ...
    "textLink.activeForeground": C.ember,
    "textLink.foreground": C.ember,
    ...
    "progressBar.background": C.ember,
    ...
    "list.highlightForeground": C.ember,
    ...
    "list.warningForeground": C.ember,
    ...
    "activityBarBadge.background": C.ember,
    ...
    "editorCursor.foreground": C.ember,
    ...
    "editorOverviewRuler.warningForeground": C.ember,
    ...
    "editorWarning.foreground": C.ember,
    ...
    "problemsWarningIcon.foreground": C.ember,
    ...
    "notificationsWarningIcon.foreground": C.ember,
    ...
    "settings.modifiedItemIndicator": C.ember,
    ...
    "minimap.warningHighlight": C.ember,
